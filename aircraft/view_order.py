...
def orderAdd(request):
    ...
    # 生成票
    newTicket = ticket(corp=checkFlight.corp, flight_id=flight_num, user_id=user_id, ticket_type=ticket_type,
                       boarding_time=checkFlight.depart_time, seat_num=seat_num, port=checkFlight.port)
    newTicket.save()
    # 生成订单
